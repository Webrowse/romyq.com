...
You need [Claude Code](https://claude.ai/code) installed and authenticated for the execution provider. For planning, `romyq init` lets you choose [DeepSeek](https://platform.deepseek.com/) (default), [OpenAI](https://platform.openai.com/), or any custom OpenAI-compatible endpoint. Set the key in `.env`:

```
DEEPSEEK_API_KEY=sk-...
```

Or, for a non-DeepSeek provider:
