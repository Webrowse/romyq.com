...
const staticPages: MetadataRoute.Sitemap = [
  ...
  { url: `${BASE}/releases/0.11.0`, lastModified: NOW, changeFrequency: "yearly", priority: 0.7 },
  { url: `${BASE}/releases/0.10.3`, lastModified: NOW, changeFrequency: "yearly", priority: 0.6 },
